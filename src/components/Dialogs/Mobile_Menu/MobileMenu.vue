  ...
  <div
    :class="[
      state.currentContent === 'about' || state.currentContent === 'providers'
        ? 'border-b-4 border-b-dark-blue'
        : '',
      state.currentContent === 'patients' ? 'border-b-4 border-b-teal' : '',
    ]"
    class="fixed left-1/2 -translate-x-1/2 top-2 flex flex-col w-[95vw] shadow-2xl bg-white z-50 py-[37px] px-3 rounded-xl border-[1px] border-dark-grey"
  >

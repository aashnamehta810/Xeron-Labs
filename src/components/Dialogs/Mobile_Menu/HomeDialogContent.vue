...
const emits = defineEmits(['about', 'patients', 'providers'])
...
const socials = [
  {
    name: "instagram",
    link: "",
    svg: `    <svg class="w-[17px] text-leather" fill="currentColor" height="16" viewBox="0 0 16 16"
             xmlns="http://www.w3.org/2000/svg">
          <path
  ...
  },
  {
    name: "linkedin",
    link: "",
    svg: `           <svg class="text-leather w-[17px]" fill="currentColor" height="16" viewBox="0 0 16 16"
             xmlns="http://www.w3.org/2000/svg">
          <path

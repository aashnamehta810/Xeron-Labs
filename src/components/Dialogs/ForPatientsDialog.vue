<template>
  <div
    class="hidden lg:flex dialog absolute flex-row w-[700px] h-[333px] items-center bg-white border-t-teal px-[41px] gap-[60px] top-[80px] right-0 z-20 shadow-[#9ca0a68f] shadow-2xl"
    @click.stop=""
  >
    <div class="flex flex-col w-1/2">
      ...
      <p class="h2 tracking-[0px] mt-[31px] w-8/12">Our Online Portal</p>
